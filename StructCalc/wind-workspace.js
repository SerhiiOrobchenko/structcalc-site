...
async function loadWindScripts() {
  ...
  try { await loadScriptTag('zones-cc-pitched-free.js?v=1'); } catch(e) { console.warn('zones-cc-pitched-free load failed:', e); }
  try { await loadScriptTag('zones-cc-troughed-free.js?v=1'); } catch(e) { console.warn('zones-cc-troughed-free load failed:', e); }
